	...
	<div class="container ">
		<div class="row">
			<div class="col-lg-4 col-sm-12 text-center">
				<a href="#"><img class="img-circle" alt="140x140"
					style="width: 140px; height: 140px;"
					src="resources/images/Park.JPG" data-holder-rendered="true"></a>
				<h3 class="designerH">박유철</h3>
				<p class="designerp">★★★★★</p>
				<p class="designerp">상호명</p>
				<p class="designerp">주소</p>
				<p class="designerp">한줄소개</p>
			</div>
			<div class="col-lg-4 col-sm-12 text-center">
				<a href="#"><img class="img-circle" alt="140x140"
					style="width: 140px; height: 140px;" src="resources/images/Lee.jpg"
			...
			<div class="col-lg-4 col-sm-12 text-center">
				<a href="#"><img class="img-circle" alt="140x140"
					style="width: 140px; height: 140px;"
					src="resources/images/jiyeon.JPG" data-holder-rendered="true"></a>
			...
			<div class="col-lg-4 col-sm-12 text-center">
				<a href="#"><img class="img-circle" alt="140x140"
					style="width: 140px; height: 140px;"
					src="resources/images/Andre01.JPG" data-holder-rendered="true"></a>
			...
			<div class="col-lg-4 col-sm-12 text-center">
				<a href="#"><img class="img-circle" alt="140x140"
					style="width: 140px; height: 140px;"
					src="resources/images/kyuri01.JPG" data-holder-rendered="true"></a>
			...
			<div class="col-lg-4 col-sm-12 text-center">
				<a href="#"><img class="img-circle" alt="140x140"
					style="width: 140px; height: 140px;"
					src="resources/images/hyelim01.JPG" data-holder-rendered="true"></a>
